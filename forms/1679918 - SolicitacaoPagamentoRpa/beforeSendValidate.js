            ...
            +'<item>'
                +'<attachs></attachs>'
                    +'<cardData>'
                        ...
                        +'<value>' + $('#solicitanteProcesso').val() +'</value>'
                    +'</cardData>'
                    +'<cardData>'
                    ...
                    +'<documentDescription>' + $('#codSolicitacao').val() + ' - ' + 'Pagamento RPA</documentDescription>' // producao: 4875548   teste: 4733487
