...
function setSelectedZoomItem(item) {
  ...
  else if (typer.indexOf("filialGuardChu") >= 0) { // == "filialGuardChu___" + index) {
  ...
  else if (typer.indexOf("filialGuardChuPedido") >= 0) { //(typer == "filialGuardChuPedido___" + index) {
    window["filialGuardChuPedido___" + index].setValue(
      item.CODIGO + " - " + item.DESCRICAO
    );
    console.log();
