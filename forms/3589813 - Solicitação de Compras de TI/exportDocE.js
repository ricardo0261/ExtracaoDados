function exportarDocE() {
    ...
    var numPropostaTecnica = $('#numPropTecnica').val();
    ...
    var dados = {
        ...
        numPropostaTecnica: numPropostaTecnica,
        condEspeciais,
        condEspeciais,
    ...
    if (origem == "https://oncoclinicastst.fluig.com") {
        file = "2977405"; // Pasta de melhoria continua no Juridico
    } else if (origem == "https://oncoclinicas.fluig.com") {
        file = "3285489"; // Raiz/Grupo Oncoclinicas
    } else if (origem == "https://oncoclinicasdev.fluig.com") {
        file = "3233943"; // Raiz/Grupo Oncoclinicas
    }
    ...
    $.ajax({
        ...
        type: "GET",
        dataType: 'json',
        url: window.location.origin + '/api/public/2.0/documents/getDownloadURL/' + file,
    }).done(function(doc) {
        file = doc.content;
    })
