function renderXmlSolicitacaoDiversos(vueApp, listProduto, classificao) {
   var xml = '<?xml version="1.0" encoding="UTF-8"?>' +
    ...
    '<soapenv:Body>' +
        '<ws:startProcessClassic>' +
            ...
            '<processId>SolicitacaoComprasDiversos</processId>' +
            ...
            '<cardData>' +
                ...
                '<item>' +
                    ...
                    '<value>' + vueApp.form.campoIdentificador + '</value>' +
                '</item>';
