            ...
            +'<item>'
                +'<attachs></attachs>'
                    +'<cardData>'
                        ...
                        +'<value>' + $('#nomeSolic').val() +'</value>'
                    +'</cardData>'
                    +'<cardData>'
                        +'<field>codSolic</field>'
                        +'<value>' + $('#codSolic').val() +'</value>'
                    +'</cardData>'
                    +'<cardData>'
                        +'<field>emailSolic</field>'
                        +'<value>' + $('#emailSolic').val() +'</value>'
                    +'</cardData>'
                    +'<cardData>'
                    ...
                    +'<cardData>'
                        ...
                        +'<value>Adiantamento e Reembolso</value>'
                    +'</cardData>'
                    +'<cardData>'
                    ...
                    +'<documentDescription>' + $('#codSolicitacao').val() + ' - ' + 'Adiantamento e Reembolso</documentDescription>' // producao: 4875548   teste: 4733487
