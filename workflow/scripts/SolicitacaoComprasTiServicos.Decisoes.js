...
function validaDecisaoInicial() {
    if (hAPI.getCardValue('isProdutoTI') == 'sim' && hAPI.getCardValue('decisaoAprovAnaliseTI') != 'sim') {
    	// log.info("#FRED "+"isProdutoTI: "+hAPI.getCardValue('isProdutoTI')+"decisaoAprovAnaliseTI: "+hAPI.getCardValue('decisaoAprovAnaliseTI'));
        return "TI";
    } else if (hAPI.getCardValue('hideFornecedorExclu') == 'true') {
    	// log.info("#FRED "+"hideFornecedorExclu: "+hAPI.getCardValue('hideFornecedorExclu'));
        return "carta";
    } else if (hAPI.getCardValue('hideFornecedorExclu') == 'false' && hAPI.getCardValue('isProdutoTI') == 'nao') {
    	// log.info("#FRED "+"hideFornecedorExclu: "+hAPI.getCardValue('hideFornecedorExclu')+"isProdutoTI: "+hAPI.getCardValue('isProdutoTI'));
        if (hAPI.getCardValue('tipoCompra') == '5') {
        	// log.info("#FRED "+"tipoCompra: "+hAPI.getCardValue('tipoCompra'));
            if (hAPI.getCardValue('tomarCienciaObra') == 'true') {
            	// log.info("#FRED obras"+"tomarCienciaObra: "+hAPI.getCardValue('tomarCienciaObra'));
                return "obras";
            } else {
            	// log.info("#FRED compra"+"tomarCienciaObra: "+hAPI.getCardValue('tomarCienciaObra'));
                return "compra";
            }
        } else {
        	// log.info("#FRED compra"+"tomarCienciaObra: "+hAPI.getCardValue('tomarCienciaObra'));
