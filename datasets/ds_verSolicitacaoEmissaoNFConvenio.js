function createDataset(fields, constraints, sortFields) {
	...
	// PROCESSO
	var processo = 'solicitacaoEmissaoNFConvenio';
	...
	var minhaQuery = 
		...
		" 'solicitacaoEmissaoNFConvenio' AS DESCRICAO, "+
	...
	// Log para debug
	log.info("### ds_verSolicitacaoEmissaoNFConvenio TABELA_PRINCIPAL: " + TABELA_PRINCIPAL);
	log.info("### ds_verSolicitacaoEmissaoNFConvenio Query SQL: " + minhaQuery);
